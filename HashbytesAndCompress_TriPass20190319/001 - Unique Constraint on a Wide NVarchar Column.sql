...
--****************************************************************************
INSERT INTO dbo.ProductPage 
(PageUrl, QuantityAvailable, Price, ProductTitle, LastUpdateDateUTC)
SELECT 
...
--****************************************************************************
ALTER TABLE dbo.ProductPage ADD PageUrlHash AS CAST(HASHBYTES('SHA1', PageUrl) 
	AS VARBINARY(20)) PERSISTED;

--****************************************************************************
-- Create a unique constraint on the hash value
--****************************************************************************
ALTER TABLE dbo.ProductPage ADD CONSTRAINT UQ_ProductPage_PageUrlHash 
	UNIQUE (PageUrlHash);
