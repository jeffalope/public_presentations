...
ALTER TABLE dbo.EventLog ADD ContentData AS CASE WHEN RawContentData IS NULL THEN CAST(DECOMPRESS(CompressedContentData) AS NVARCHAR(MAX)) ELSE RawContentData END;
...
BEGIN
	...
	INSERT INTO dbo.EventLog (EventDate, EventType, UserID, CompressedContentData)
